	...
	return (
		<>
			<div className={'hidden md:block'}>
				...
				<div className={'dark:grain-background checkout-background-base min-h-[1280px]'}></div>
			...
			<div className={'block md:hidden'}>
				...
				<div className={'dark:grain-background checkout-background-base h-full min-h-screen'}></div>
			</div>
		</>
	);
}